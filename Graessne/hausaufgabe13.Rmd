...
Versuchsperonen als Spalten sieht für mich übersichtlicher aus.
...
Ich finde den Jitterplot am schwierigsten zu interpretieren, da nur einzelne Datenpunkte gezeigt werden. Mit dem Boxplot lassen sich die Mediane gut ablesen. Anhand der Dichteverteilung kann man Gemeinsamkeiten der Bedingungen (Raum,wo sich alle Kurven überschneiden) und Unterschiede (Raum wo bspw nur eine Bedingung eine bsonders hohe Dichte hat) erkennen. Außerdem hat man einen Überblick, ob die Kurven normalverteilt sind.
...
Bei den Single-Trial-Daten sehen die 4 Conditions ähnlich verteilt aus, bei den
Daten by Subject und by Item wird deutlich, dass DD die höchste Dichte bei ca 500ms
hat und die anderen Conditions (besonders DE) eine langsamere Reaktionszeit hervorrufen
...
# Lizenz
Dieses Datei dient nur zu Prüfungszwecken

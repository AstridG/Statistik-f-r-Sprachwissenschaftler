...
for (s in c(3, 4, 5)) {
    ...
    output <- paste("Bei einer Standabweichung von", s, "bestehen", ausgezeichnet * 
        100, "% mit einer ausgezeichneten Note.")
    print(output)
}
```

```
## [1] "Bei einer Standabweichung von 3 bestehen 4.77903522728147 % mit einer ausgezeichneten Note."
## [1] "Bei einer Standabweichung von 4 bestehen 10.5649773666855 % mit einer ausgezeichneten Note."
## [1] "Bei einer Standabweichung von 5 bestehen 15.8655253931457 % mit einer ausgezeichneten Note."
```


Wie steht die Anzahl guter Noten in Beziehung zur Anzahl schlechter Noten? 

Es gibt mehr schlechte als gute Noten
Warum?

Schlechte Noten wurden als alle unter 5 Notenpunkte definiert. Also 4,3,2,1 Punkte. Gute Noten wurden als alle ab 13 Notenpunkte definiert, also 13,14, 15 Punkte. Unser Bereich der schlechten Noten ist als größer als der der Guten und somit fallen da auch mehr Prozent rein.
...
Bei diesem Dozenten ist die Verwaltung wirklich unsicher, ob und was für einen Unterschied es geben könnte. (Welche Testart sollte man hier nutzen?) zweiseitig
...
Das ist ein **insignifikanter** Unterschied, da z < 1.88.
...
Das ist ein **signifikanter** Unterschied, da 4.7 > 1.88

Ist die Benotung vom Dozenten weniger als ideal? 

### Ein anderer, böserer? Dozent
Die Verwaltung ist auch auf einen anderen Dozenten aufmerksam geworden, weil manche Studenten behaupten, er würde zu streng benoten. (Welche Testart sollte man hier nutzen?) einseitig

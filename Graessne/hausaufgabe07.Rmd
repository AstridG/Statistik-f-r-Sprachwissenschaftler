...
for(s in c(3,4,5) ){
  ...
  output <- paste("Bei einer Standabweichung von",s, "bestehen",ausgezeichnet*100,"% mit einer ausgezeichneten Note.")
  print(output)
}
```
...
Schlechte Noten wurden als alle unter 5 Notenpunkte definiert. Also 4,3,2,1 Punkte. Gute Noten wurden als alle ab 13 Notenpunkte definiert, also 13,14,15.(oder vielleicht sogar nur 14 und 15?) Unser Bereich der schlechten Noten ist als größer als der der Guten und somit fallen da auch mehr Prozent rein.
